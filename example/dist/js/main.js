...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Route$DefaultRoute$NotFoundRoute = __webpack_require__(3);
	...
	var _NotFound = __webpack_require__(7);
	...
	var routes = _React2['default'].createElement(
	  ...
	  _React2['default'].createElement(_Route$DefaultRoute$NotFoundRoute.Route, { name: 'main', handler: _Main2['default'] }),
	  _React2['default'].createElement(_Route$DefaultRoute$NotFoundRoute.Route, { name: 'about', handler: _About2['default'] }),
	  _React2['default'].createElement(_Route$DefaultRoute$NotFoundRoute.DefaultRoute, { handler: _Main2['default'] }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Reflux = __webpack_require__(33);
	var UserList = __webpack_require__(30);
	var UserActions = __webpack_require__(31);
	var UserStore = __webpack_require__(32);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(UserList, this.state)
	    );
	  }
	});
	    ...
	    value: function render() {
	      return _React2['default'].createElement(
	        ...
	        _React2['default'].createElement(
	          'p',
	          null,
	          'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe aliquam, aspernatur possimus natus. Sapiente odio quibusdam eum sunt, velit vel saepe facere voluptas animi explicabo consequuntur provident id at quis.'
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserRow = __webpack_require__(69);
	  ...
	  _createClass(UserList, [{
	    ...
	    value: function render() {
	      var users = this.props.users.map(function (user) {
	        return _React2['default'].createElement(_UserRow2['default'], { key: user.id, user: user });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Reflux = __webpack_require__(33);
	
	var _Reflux2 = _interopRequireDefault(_Reflux);
	
	var UserActions = _Reflux2['default'].createActions(['loadUsers', 'loadUsersSuccess', 'loadUsersError']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserActions = __webpack_require__(31);
	
	var _UserActions2 = _interopRequireDefault(_UserActions);
	
	'use strict';
	
	var Resource = __webpack_require__(134);
	var users = new Resource('http://localhost:3000/api/users/:id', { id: '@id' }, {});
	
	var UserStore = _Reflux2['default'].createStore({
	  init: function init() {
	    this.users = [];
	
	    this.listenTo(_UserActions2['default'].loadUsers, this.loadUsers);
	    this.listenTo(_UserActions2['default'].loadUsersSuccess, this.loadUsersSuccess);
	    this.listenTo(_UserActions2['default'].loadUsersError, this.loadUsersError);
	  },
	  ...
	  loadUsersSuccess: function loadUsersSuccess(users) {
	    var self = this;
	    console.log(users);
	  ...
	  triggerUsers: function triggerUsers() {
	    this.trigger({
	      users: this.users,
	      loading: false
	    });
	  ...
	  loadUsersError: function loadUsersError(error) {
	    this.trigger({
	      error: error,
	      loading: false
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLifeCycle = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserRow = (function (_React$Component) {
	  function UserRow() {
	    ...
	    _get(Object.getPrototypeOf(UserRow.prototype), 'constructor', this).call(this);
	  }
	    ...
	    value: function render() {
	      return _React2['default'].createElement(
	        ...
	        _React2['default'].createElement(
	          ...
	          _React2['default'].createElement(
	            'button',
	            { onClick: this.props.user.onDelete },
	            'Del'
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ActionMethods = __webpack_require__(180);
	
	exports.ListenerMethods = __webpack_require__(181);
	
	exports.PublisherMethods = __webpack_require__(182);
	
	exports.StoreMethods = __webpack_require__(183);
	
	exports.createAction = __webpack_require__(184);
	
	exports.createStore = __webpack_require__(185);
	
	exports.connect = __webpack_require__(186);
	
	exports.connectFilter = __webpack_require__(187);
	
	exports.ListenerMixin = __webpack_require__(188);
	
	exports.listenTo = __webpack_require__(189);
	
	exports.listenToMany = __webpack_require__(190);
	
	
	var maker = __webpack_require__(191).staticJoinCreator;
	 ...
	 */
	exports.__keep = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var copy = (function (_copy) {
	  ...
	  return copy;
	})(function (source, destination, stackSource, stackDest) {
	  if (isWindow(source)) {
	    throw minErr('cpws', 'Can\'t copy! Making copies of Window or Scope instances is not supported.');
	  }
	  if (isTypedArray(destination)) {
	    throw minErr('cpta', 'Can\'t copy! TypedArray destination cannot be mutated.');
	  }
	  ...
	  if (!destination) {
	    ...
	    if (source === destination) throw minErr('cpi', 'Can\'t copy! Source and destination are identical.');
	...
	var q = __webpack_require__(214);
	var http = __webpack_require__(215);
	      ...
	      Resource[name] = function (a1, a2, a3, a4) {
	        ...
	        switch (arguments.length) {
	          ...
	          case 0:
	            break;
	          default:
	            throw minErr('badargs', 'Expected up to 4 arguments [params, data, success, error], got {0} arguments', arguments.length);
	        }
	        /* jshint +W086 */ /* (purposefully fall through case statements) */
	        ...
	        var promise = http(httpConfig).then(function (response) {
	          ...
	          if (data) {
	            ...
	            if (isArray(data) !== !!action.isArray) {
	              throw minErr('badcfg', 'Error in resource configuration for action `{0}`. Expected response to ' + 'contain an {1} but got an {2}', name, action.isArray ? 'array' : 'object', isArray(data) ? 'array' : 'object');
	            }
	            // jshint +W018
	            if (action.isArray) {
	              value.length = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentEnvironment = __webpack_require__(157);
	var ReactMultiChildUpdateTypes = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(192),
	    maker = __webpack_require__(191).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(192),
	    Reflux = __webpack_require__(132),
	    Keep = __webpack_require__(193),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(132),
	    _ = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slice = Array.prototype.slice,
	    _ = __webpack_require__(192),
	    createStore = __webpack_require__(185),
	    strategyMethodNames = {
	        strict: "joinStrict",
	        first: "joinLeading",
	        last: "joinTrailing",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(216);
	...
	exports.Promise = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(68), __webpack_require__(226).setImmediate))
